...
namespace RtmpSharp.Net
{
    ...
    class RtmpPacketReader
    {
        ...
        public void ReadLoop()
        {
            ...
            {
                Console.WriteLine("Exception: {0} at {1}", ex, ex.StackTrace);
                if (ex.InnerException != null)
                {
                    var inner = ex.InnerException;
                    Console.WriteLine("InnerException: {0} at {1}", inner, inner.StackTrace);
                }
        ...
        RtmpHeader ReadHeader()
        {
            ...
            switch (chunkMessageHeaderType)
            {
                ...
                case ChunkMessageHeaderType.Continuation:
                    ...
                    break;
                default:
                    Console.WriteLine("Unexpected header type: " + (int)chunkMessageHeaderType);
                    break;
            }
