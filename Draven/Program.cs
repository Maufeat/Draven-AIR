...
namespace Draven
{
    class Program
    {
        ...
        /*static void ClientCommandReceieved(object sender, CommandMessageReceivedEventArgs e)
        {
            ...
            Console.WriteLine("[LOG][" + targetSummoner._session.Summary.Username + "] CommandRecv: " + e.Message.Operation);
            if (e.Message.Operation == CommandOperation.Login)
            {
                ClientDynamicConfigurationNotification clientConfig = new ClientDynamicConfigurationNotification
                {
                ...
                targetSummoner._rtmpClient.InvokeDestReceive("cn-"+targetSummoner._rtmpClient.ClientId, "cn-" + targetSummoner._rtmpClient.ClientId, "messagingDestination", clientConfig);
            }
        }*/
