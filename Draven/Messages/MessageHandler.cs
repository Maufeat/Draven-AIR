...
namespace Draven.Messages
{
    public class MessageHandler
    {
        ...
        public void Register(string Destination)
        {
            ...
            var structures = Assembly.GetExecutingAssembly().GetTypes().Where(x => String.Equals(x.Namespace, string.Format("Draven.Messages.{0}", Destination), StringComparison.Ordinal));
